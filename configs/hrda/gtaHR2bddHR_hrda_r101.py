...
_base_ = [
    ...
    '../_base_/datasets/uda_gtaHR_to_bdd100kHR_1024x1024.py',
...
checkpoint_config = dict(by_epoch=False, interval=8000, max_keep_ckpts=2, create_symlink=False)
evaluation = dict(interval=4000, metric='mIoU')
# Meta Information for Result Analysis
name = 'gtaHR2bdd100kHR_hrda_r101'
exp = 'basic'
name_dataset = 'gtaHR2bdd100kHR_1024x1024'
name_architecture = 'hrda1-512-0.1_segformer_r101'
name_encoder = 'r101'
