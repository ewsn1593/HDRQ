...
_base_ = [
    ...
    '../_base_/datasets/uda_gtaHR_to_iddHR_1024x1024.py',
...
name = 'gtaHR2iddHR_hrda_r101'
exp = 'basic'
name_dataset = 'gtaHR2iddHR_1024x1024'
name_architecture = 'hrda1-512-0.1_daformer_segformer_r101'
name_encoder = 'r101'
